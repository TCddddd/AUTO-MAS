...
8. Before completing a user-visible feature or fix, update `res/version.json` under the next unreleased version as part of the implementation; do not merely remind the developer. Do not create a commit unless the user explicitly asks for one.
