...
"""ok-script runtime lock facade."""

from pathlib import Path

from app.utils import get_path_runtime_lock


def get_ok_script_root_lock(root_path: Path):
    """Return the shared lock for one ok-script project root."""
